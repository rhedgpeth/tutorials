...
[.links]
xref:standalone@userprofile-couchbase-mobile-xamarin:userprofile:xamarin/userprofile_basic.adoc[Standalone]
xref:query@userprofile-couchbase-mobile-xamarin:userprofile:xamarin/userprofile_query.adoc[Query]
